...
def main():
    ...
    print("-" * 25)
    print("• outputs/submission.csv - Notebook predictions")
    print("• outputs/submission_final.csv - Main pipeline predictions")
    print("• data/processed/train_experimental.csv - Enhanced training data (53 features)")
    print("• data/processed/test_experimental.csv - Enhanced test data (49 features)")
